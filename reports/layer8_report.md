...
**Run:** 2026-09-08T12:57:33.685820Z
**Snapshots analysiert:** 351
**Vollständige Tagespaare:** 55

## System-State Häufigkeit

- `seasonal_transition_state` — 333× (94.9%)
...
Coverage: 333/351 Snapshots

### Aktuelle Operator-Rangliste

- **resonance_model**: 0.475 — modellierter nicht-geometrischer Anteil über Cavity-Geometrie hinaus
- **thermal**: 0.429 — moderate thermische Vorbereitung vorhanden
- **electric**: 0.396 — moderate elektrische Kopplung  ⚠️ confounded_circular
- **ionization**: 0.330 — Ionosphärenstörung: starker Strahlungseffekt auf Ausbreitung
- **geomagnetic**: 0.289 — ruhige geomagnetische Bedingungen
- **cross_layer_activation**: 0.134 — keine Übergangsspannung — Layer kohärent  ⚠️ confounded_circular
